...
//		SetWin ();
	...
	{
        //Game.AudioManager.Instance.StopBgAudio();
		...
		{
            //Game.AudioManager.Instance.PlayLongVoiceAudio(Resources.Load(AudioDefine.PATH_HERO_KILLSOUND + "Victory") as AudioClip);
            ...
            Game.AudioManager.Instance.PlayLongVoiceAudio(clip);
        ...
        else if (player.StateSituation == SITUATION.LOSE)
        {
            ...
            //Game.AudioManager.Instance.PlayLongVoiceAudio(Resources.Load(AudioDefine.PATH_HERO_KILLSOUND + "Failed") as AudioClip);
...
//			GameLogic.Instance.SetGameState (GameDefine.GameState.STATE_LOBBY);
