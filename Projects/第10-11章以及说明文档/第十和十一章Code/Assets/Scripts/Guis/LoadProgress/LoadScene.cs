...
public class LoadScene : MonoBehaviour {
   ...
   // private float xOffset = 45f;
    ...
    //    Game.Resource.ResourceManager.Instance.loadProcess.AddLogicFile("Scene/Prefab/" + name + "_Scene.assetbundle", Game.Resource.LogicResouce.ELogicResType.ERes_Scene);
    //    Game.Resource.ResourceManager.Instance.loadProcess.SceneRes = "Scene/Prefab/" + name + "_Scene.assetbundle";
    //}
	public void LoadAsignedSene(string name)
    {
        //���س���֮ǰ��Ҫ�����������
        Game.Effect.EffectManager.Instance.DestroyAllEffect();
        //���GameObjectPool����
    ...
    public delegate void LoadFinish(Game.GameState.GameStateType St);
