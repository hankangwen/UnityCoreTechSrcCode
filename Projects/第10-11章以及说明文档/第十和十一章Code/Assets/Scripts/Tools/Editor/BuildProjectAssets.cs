...
public class BuildProjectAssets
{
    ...
    static void ExportScene(string path, BuildTarget bTarget)
    {
        ...
        foreach (UnityEngine.Object o in refObjs)
        {
            ...
            if (render != null && render.sharedMaterial != null)
            {
                ...
                //}
                //Game.Resource.LightmapHelper lightMapHelper = render.gameObject.GetComponent<Game.Resource.LightmapHelper>();
                //if (lightMapHelper == null)
                //{
                //    lightMapHelper = render.gameObject.AddComponent<Game.Resource.LightmapHelper>();
                //}
        ...
        /////
        {
            ...
            Game.Resource.EnviromentSetting settings = root.GetComponent<Game.Resource.EnviromentSetting>();//
            if (settings == null)
            {
                settings = root.AddComponent<Game.Resource.EnviromentSetting>();
            }
        ...
        ////
        //lightmap index
        Game.Resource.StringScriptableObject lightmapindexholder = ScriptableObject.CreateInstance<Game.Resource.StringScriptableObject>();
        ...
        UnityEngine.Object lightmapIndex = AssetDatabase.LoadAssetAtPath("Assets/temp/LightMapIndex.asset", typeof(Game.Resource.StringScriptableObject));
        //

        Game.Resource.StringScriptableObject holder = ScriptableObject.CreateInstance<Game.Resource.StringScriptableObject>();
        holder.content = depBundleNames.ToArray();
        AssetDatabase.CreateAsset(holder, "Assets/temp/DependentBundleNames.asset");
        UnityEngine.Object depBundleDescription = AssetDatabase.LoadAssetAtPath("Assets/temp/DependentBundleNames.asset", typeof(Game.Resource.StringScriptableObject));
    ...
    static void ExportAllCharacterAssetBundles(BuildTarget bTarget)
    {
        ...
        foreach (string s in characters)
        {
            ...
            Game.Resource.StringScriptableObject stringSO = ScriptableObject.CreateInstance<Game.Resource.StringScriptableObject>();
            stringSO.content = depBundleNames.ToArray();
            AssetDatabase.CreateAsset(stringSO, "Assets/Export/Temp/DependentBundleNames.asset");
            UnityEngine.Object depBundleDescription = AssetDatabase.LoadAssetAtPath("Assets/Export/Temp/DependentBundleNames.asset", typeof(Game.Resource.StringScriptableObject));
