...
namespace Game
{
    public class AudioManager
    {
        ...
        private void InitAudio()
        {
            ...
            {
                AudioSource ad = GameLogic.Instance.gameObject.AddComponent<AudioSource>();
            ...
            HeroMoveAudio = GameLogic.Instance.gameObject.AddComponent<AudioSource>();
            HeroMoveAudio.volume = Settings.AudioVolume;
            HeroMoveAudio.loop = true;
            HeroMoveAudio.playOnAwake = false;

            LoopAudioSource = GameLogic.Instance.gameObject.AddComponent<AudioSource>();
            LoopAudioSource.loop = true;
            LoopAudioSource.playOnAwake = false;
            LoopAudioSource.volume = Settings.AudioVolume;

            GameKillAudioSource = GameLogic.Instance.gameObject.AddComponent<AudioSource>();
            GameKillAudioSource.volume = Settings.AudioVolume;

            HeroGetMoneySource = GameLogic.Instance.gameObject.AddComponent<AudioSource>();
            HeroGetMoneySource.volume = Settings.AudioVolume;


            GuideVoice = GameLogic.Instance.gameObject.AddComponent<AudioSource>();
