...
namespace Game
{
    ...
    public class GameConfig : Singleton<GameConfig>
    {
        ...
        public void Init()
        {
            ...
            if (effectLevel == "High")
            {
                Game.Effect.EffectManager.Instance.SetEffectLodLevel(Effect.EffectLodLevel.High);
            }
            //特效低效果
            else
            {
                Game.Effect.EffectManager.Instance.SetEffectLodLevel(Effect.EffectLodLevel.Low);
            } 
        }
