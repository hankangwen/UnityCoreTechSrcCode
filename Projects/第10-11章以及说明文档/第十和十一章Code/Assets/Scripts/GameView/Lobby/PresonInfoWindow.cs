...
namespace Game.View
{
    public class PresonInfoWindow : BaseWindow
    {
        ...
        {
            if (Game.Ctrl.PresonInfoCtrl.Instance.GetTimeExp() && PresonInfoCtrl.Instance.GetExpLastMin())
                ChangeExpTime();
            if (Game.Ctrl.PresonInfoCtrl.Instance.GetTimeGold() && PresonInfoCtrl.Instance.GetGoldLastMin())
                ChangeGoldTime();
        }
        ...
        public override void OnEnable()
        {
            ...
            if (Game.Ctrl.PresonInfoCtrl.Instance.GetTimeExp())
                ChangeExpTime();
            if (Game.Ctrl.PresonInfoCtrl.Instance.GetTimeGold())
                ChangeGoldTime();
