...
namespace Game.GameEntity
{
    public class Iselfplayer : Iplayer
    {
        ...
        public override void OnReborn()
        {
            ...
            Game.AudioManager.Instance.PlayEffectAudio(RebornClip);
        ...
        private void setCircleEnable(GameObject obj, bool bEnabled)
        {
            ...
            if (bEnabled == true)
            {
                if (SyncLockTarget != null && SyncLockTarget.realObject != null)
                {
                    ...
                    float radius = 1.0f;
                    if (CTools.IfTypeHero((MO.MOBA.GameData.EObjectType)SyncLockTarget.NpcGUIDType))
                    {
        ...
        {
            Game.AudioManager.Instance.PlayHeroAudio(WalkAudioClip);
            base.OnEnterMove();
        }
        ...
        public override void OnEnterDead()
        {
            ...
            Game.AudioManager.Instance.PlayEffectAudio(DeadAudioClip);
            RemoveRuinWarning();
