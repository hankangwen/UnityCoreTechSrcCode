...
public static class LuaBinder
{
	...
	public static void Bind(IntPtr L, string type = null)
	{
		...
		switch (type) {
			...
			case "BIEFramework_AppConstWrap": BIEFramework_AppConstWrap.Register(L); break;
			case "BIEFramework_ByteBufferWrap": BIEFramework_ByteBufferWrap.Register(L); break;
			case "BIEFramework_LuaBehaviourWrap": BIEFramework_LuaBehaviourWrap.Register(L); break;
			case "BIEFramework_LuaHelperWrap": BIEFramework_LuaHelperWrap.Register(L); break;
			case "BIEFramework_Manager_MusicManagerWrap": BIEFramework_Manager_MusicManagerWrap.Register(L); break;
			case "BIEFramework_Manager_PanelManagerWrap": BIEFramework_Manager_PanelManagerWrap.Register(L); break;
			case "BIEFramework_Manager_ResourceManagerWrap": BIEFramework_Manager_ResourceManagerWrap.Register(L); break;
			case "BIEFramework_Manager_TimerManagerWrap": BIEFramework_Manager_TimerManagerWrap.Register(L); break;
			case "BIEFramework_UtilWrap": BIEFramework_UtilWrap.Register(L); break;
