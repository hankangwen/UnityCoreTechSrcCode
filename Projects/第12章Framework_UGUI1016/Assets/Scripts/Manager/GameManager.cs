...
namespace BIEFramework.Manager {
    public class GameManager : LuaBehaviour {
        ...
        void Init() {
			...
			Facade.Instance.AddManager(ManagerName.Lua, new LuaScriptMgr());
...
//			AppFacade.Instance.AddManager<NetworkManager>(ManagerName.Network);
			...
			Facade.Instance.AddManager<ThreadManager>(ManagerName.Thread);
...
//            facade.SendMessageCommand(NotiConst.UPDATE_MESSAGE, message);
        ...
        public void OnResourceInited() {
            Facade.Instance.LuaManager.Start();
			Facade.Instance.LuaManager.DoFile("Logic/Network");      //加载游戏
			Facade.Instance.LuaManager.DoFile("Logic/GameManager");   //加载网络
            initialize = true;  
           ...
           // NetManager.OnInit();    //初始化网络
            ...
            foreach (object o in panels) {
				...
				Facade.Instance.LuaManager.DoFile("View/" + name);
        ...
        void Update() {
			if (Facade.Instance.LuaManager != null && initialize) {
				Facade.Instance.LuaManager.Update();
            }
        }

        void LateUpdate() {
			if (Facade.Instance.LuaManager != null && initialize) {
				Facade.Instance.LuaManager.LateUpate();
            }
        }

        void FixedUpdate() {
			if (Facade.Instance.LuaManager != null && initialize) {
				Facade.Instance.LuaManager.FixedUpdate();
            }
        }
        ...
        /// </summary>
        void OnDestroy() {
			if (Facade.Instance.LuaManager != null) {
				Facade.Instance.LuaManager.Destroy();
