...
public class FPSCounter : MonoBehaviour {
    ...
    void OnGUI() {
		...
		if (guiEnabled) {
            ...
            wind.forceStorm = GUI.Toggle(new Rect(80, 20, 130, 20), wind.forceStorm, "ForceStrom");
            wind.waveScale = LabelSlider("Scale:", new Rect(20, 60, 130, 20), wind.waveScale, 1f, 10f);
