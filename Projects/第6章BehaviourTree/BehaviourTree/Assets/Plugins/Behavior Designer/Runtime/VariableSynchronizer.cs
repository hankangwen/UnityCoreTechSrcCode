...
namespace BehaviorDesigner.Runtime
{
    ...
    {
        public enum SynchronizationType { BehaviorDesigner, Property, Animator, PlayMaker };
        public enum AnimatorParameterType { Bool, Float, Integer }

        [Serializable]
        public class SynchronizedVariable
        {
            public SynchronizedVariable(SynchronizationType synchronizationType, bool setVariable, Behavior behavior, string variableName, Component targetComponent, string targetName)
            {
        ...
        public void Awake()
        {
            ...
            if (synchronizedVariables != null && synchronizedVariables.Count > 0) {
                enabled = false;
                return;
            }
